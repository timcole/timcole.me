  ...
  return (
    <div className="flex-1 overflow-auto flex flex-col lg:flex-row h-full justify-between divide-y divide-x-0 lg:divide-x lg:divide-y-0 divide-cyan-900">
      <div className="w-full flex-1 justify-center align-middle flex relative">
        <Link
          href={`/${album}`}
          className="absolute z-10 opacity-0 hover:opacity-100 transition-opacity left-2 top-2 bg-primary-900 p-2 rounded-full text-primary-50"
        >
          <X />
        </Link>
        {photo?.prevFile && (
          <Link
            ...
            className="absolute z-10 opacity-60 hover:opacity-100 transition-opacity left-2 top-1/2 -translate-y-1/2 bg-primary-900 p-2 rounded-full text-primary-50"
          >
            <ChevronLeft />
          </Link>
        )}
        {photo?.nextFile && (
          <Link
            ...
            className="absolute z-10 opacity-60 hover:opacity-100 transition-opacity right-2 top-1/2 -translate-y-1/2 bg-primary-900 p-2 rounded-full text-primary-50"
          >
            <ChevronLeft className="rotate-180" />
          </Link>
        )}
        <div key={`img-${album}-${file}`} className="relative h-full w-fit">
          <img
