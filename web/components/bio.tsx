	...
	render () {
		return (
			<div className={this.props.className}>
				...
				<p>I'm a <b>{this.age()} year old</b>, self-taught, software engineer living on the coastal side of <b>North Carolina</b>.</p>
				...
				<p>Current Software Engineer at <a href="https://socialblade.com/info/team" target="_blank">Social Blade LLC</a> and Community Admin with <a href="https://link.twitch.tv/devchat" target="_blank">TwitchDev <sup>Twitch Interactive, Inc.</sup></a>.</p>
			</div>
		)
	}
}
